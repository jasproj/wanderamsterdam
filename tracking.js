/* ============================================
   WanderAmsterdam — booking_click tracking
   ============================================
   ...
   - On every FareHarbor link click, we append utm_source=wanderamsterdam
     so GA4 can attribute the booking to AMS.
...
(function () {
    /* HOSTNAME GUARD — booking_click is emitted from the live domain only.
       ...
       runs, not users. 50 of this property's 52 booking_click events — 96% — came from localhost.
       ...
       1 file(s). Guarding only this file would leave the other emitters
    ...
    var BOOKING_CLICK_ALLOWED_HOSTS = ['wanderamsterdam.com', 'www.wanderamsterdam.com'];
